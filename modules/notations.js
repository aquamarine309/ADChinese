...
export const ADNotations = (function (exports, Decimal, tslib) {
  'use strict'
  ...
  function addCommas(value) {
    return Array.from(Array(Math.ceil(value.length / 3)))
      .map(function (_, i) {
  ...
  var ImperialNotation = (function (_super) {
    ...
    ImperialNotation.prototype.checkSmallUnits = function (adjective, x, volIdx) {
      ...
      if (volIdx === 1) {
        ...
        return ''
          .concat((deciMinims / 10).toFixed(places), ' ')
          .concat(adjective)
          .concat(big[1], 's')
      }
