...
export const news = [
  ...
  },
  {
    ...
    get text() {
      ...
      const quantity = format(clicks);
      if (clicks === 1) {
        return `Nothing happens when you click this text. And yet, you've clicked it.`;
      }
      if (clicks > 1) {
        return `Nothing happens when you click this text. And yet, you've clicked it ${quantity} 次.`;
      }
  ...
  },
  {
    ...
    get text() {
      ...
      return `You see, this news isn't normal news. It is being produced by the first news dimension. If you want
        to unlock more news, you have to collect enough paperclips to build the second news dimension. 你当前拥有 ${formatInt(paperclips)} 个回形针，但你需要
        ${formatInt(paperclips + 10)} 个回形针才能买得起它。`;
    }
  },
  {
    id: "a291",
  ...
  {
    id: "p2", text: 'Die Zahlen gehen hoooch'
  },
