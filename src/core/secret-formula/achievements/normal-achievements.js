...
export const normalAchievements = [
  ...
  },
  {
    ...
    name: '6 不是 9',
    get description() {
      return Enslaved.isRunning ? '购买一个第六维度（这并没有什么特殊作用）' : '购买第六维度。'
    },
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
  ...
  },
  {
    ...
    name: '8 不是无限',
    get description() {
      return Enslaved.isRunning ? '购买一个第八反物质维度（别被骗了）' : '购买第八维度。'
    },
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
    ...
    get reward() {
      return `起始反物质数量改为 ${formatInt(100)} 反物质。`
    },
    effect: 100,
  },
  {
    ...
    name: '假新闻！',
    get description() {
      return `发现 ${formatInt(50)} 条不同的新闻消息。`
    },
  ...
  },
  {
    ...
    name: '九九归一',
    get description() {
      return `正好有 ${formatInt(99)} 个第八维度。`
    },
    checkRequirement: () => AntimatterDimension(8).amount.eq(99),
    get reward() {
      return `第八维度增强 ${formatPercents(0.1)}。`
    },
    effect: 1.1,
  },
  {
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
    get reward() {
      return `第一维度增强 ${formatPercents(0.1)}。`
    },
    effect: 1.1,
  },
  {
  ...
  },
  {
    ...
    name: '诸神之乐',
    get description() {
      return `从维度献祭中获得超过 ${formatX(600)}倍的倍数加成。(第八维度自动购买挑战除外)`
    },
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `第一维度至第七维度的效果增强 ${formatPercents(0.02)}。`
    },
    effect: 1.02,
  },
  {
    ...
    checkRequirement: () => (Date.now() - player.lastUpdate) * debugOptions.getGlobalSpeedFactor() >= 21600000,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `起始计数频率提升 ${format(1.02, 2, 2)} 倍。`
    },
    effect: 1 / 1.02,
  },
  {
    ...
    name: '那太快了！',
    get description() {
      return `在 ${formatInt(2)} 小时内达到无限。`
    },
    checkRequirement: () => Time.thisInfinityRealTime.totalHours <= 2,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `起始反物质数量改为 ${formatInt(5000)}`
    },
    effect: 5000,
  },
  {
  ...
  },
  {
    id: 43,
    name: '反客为主',
    description: '使第八反物质维度的加成倍数最高，第七反物质维度的加成倍数第二高，依此类推。',
    checkRequirement: () => {
  ...
  },
  {
    ...
    name: '比土豆还快',
    get description() {
      return `计数频率超过 ${format(DC.E29)} 每秒。`
    },
    checkRequirement: () => Tickspeed.current.exponent <= -26,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
      return `起始计数频率提升 ${formatX(1.02, 0, 2)} 倍。`
    },
    effect: 0.98,
  },
  {
    ...
    name: '多维度',
    get description() {
      return `除第八维度外的所有反物质维度达到 ${format(DC.E12)} 。`
    },
  ...
  },
  {
    ...
    checkEvent: [GAME_EVENT.BIG_CRUNCH_AFTER, GAME_EVENT.REALITY_RESET_AFTER, GAME_EVENT.REALITY_UPGRADE_TEN_BOUGHT],
    get reward() {
      return `所有维度增强 ${formatPercents(0.1)}。`
    },
    effect: 1.1,
  },
  {
  ...
  },
  {
    ...
    effect: () => Math.max(6 / (Time.thisInfinity.totalMinutes / debugOptions.getGlobalSpeedFactor() + 3), 1),
    effectCondition: () => Time.thisInfinity.totalMinutes / debugOptions.getGlobalSpeedFactor() < 3,
  ...
  },
  {
    ...
    name: '挺不错的',
    get description() {
      return `在 ${formatInt(3)} 分钟内完成计数频率自动购买器挑战（挑战9）。`
    },
  ...
  },
  {
    ...
    name: '哦，你… 你还在这里吗？',
    get description() {
      return `达到 ${format(DC.E8)} 无限点数/分钟。`
    },
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `第一维度至第四维度增强 ${formatPercents(0.25)}。`
    },
    effect: 1.25,
  },
  {
    ...
    name: '小菜一碟',
    get description() {
      return `所有挑战的完成用时之和小于 ${formatInt(3)} 分钟。`
    },
    ...
    effect: () => (Player.isInAnyChallenge ? Math.max(4 / (Time.thisInfinity.totalMinutes / debugOptions.getGlobalSpeedFactor() + 1), 1) : 1),
    effectCondition: () => Player.isInAnyChallenge && Time.thisInfinity.totalMinutes / debugOptions.getGlobalSpeedFactor() < 3,
    formatEffect: (value) => `${formatX(value, 2, 2)}`,
  },
  {
    id: 66,
    name: '比方土豆还快。',
    get description() {
      return `计数频率超过 ${format(DC.E58)} 每秒。`
    },
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `第一维度增强 ${formatPercents(0.5)}。`
    },
    effect: 1.5,
  },
  {
    id: 71,
    name: '错误909：找不到维度',
    description: () => `在第二反物质维度自动购买器挑战（挑战2）中，仅有 ${formatInt(1)} 个第一维度且没有其他维度、维度提升和反物质星系时达到无限。`,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
      return `所有反物质维度增强 ${formatPercents(0.1)}。`
    },
    effect: 1.1,
  },
  {
    ...
    name: '不存在的成就',
    get description() {
      return `获得 ${formatPostBreak(DC.D9_9999E9999, 4)} 反物质。`
    },
  ...
  },
  {
    ...
    name: '一秒都不给我',
    get description() {
      return `所有挑战的用时之和小于 ${formatInt(5)} 秒。`
    },
    checkRequirement: () => Time.challengeSum.totalSeconds < 5,
    checkEvent: [GAME_EVENT.BIG_CRUNCH_AFTER, GAME_EVENT.REALITY_RESET_AFTER],
    get reward() {
      return `在挑战中，所有的反物质维度增强 ${formatPercents(0.4)}`
    },
    effect: 1.4,
  ...
  },
  {
    ...
    name: '眨眼之间',
    get description() {
      return `在 ${formatInt(250)} 毫秒内完成无限。`
    },
  ...
  },
  {
    ...
    name: '我超喜欢游戏设计的！',
    get description() {
      return `在 ${formatInt(15)} 秒内完成无限挑战 5。`
    },
  ...
  },
  {
    ...
    name: '您可以获得50个反物质星系？！？！',
    get description() {
      return `获得 ${formatInt(50)} 个反物质星系。`
    },
    checkRequirement: () => player.galaxies >= 50,
    checkEvent: GAME_EVENT.GALAXY_RESET_AFTER,
    get reward() {
      return `每一个反物质星系使计数频率增加 ${formatPercents(0.05)}。`
    },
  ...
  },
  {
    ...
    name: '这有点多',
    get description() {
      return `获得 ${formatPostBreak('1e35000')} 反物质。`
    },
  ...
  },
  {
    ...
    name: '你的无限点数全归我们了',
    get description() {
      return `一次大坍缩获得超过 ${format(DC.E150)} 无限点数。`
    },
    checkRequirement: () => gainedInfinityPoints().exponent >= 150,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `从大坍缩中获得额外 ${formatX(4)} 倍的无限点数。`
    },
    effect: 4,
  },
  {
    ...
    name: '扭曲时间？',
    get description() {
      return `每次计数频率升级达到 ${formatX(1000)} 计数频率/秒。`
    },
    checkRequirement: () => Tickspeed.multiplier.recip().gte(1000),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
      return `星系增强 ${formatPercents(0.01)}。`
    },
    effect: 1.01,
  },
  {
  ...
  },
  {
    ...
    effect: () => Math.max((5 - Time.thisInfinity.totalSeconds / debugOptions.getGlobalSpeedFactor()) * 60, 1),
    effectCondition: () => Time.thisInfinity.totalSeconds / debugOptions.getGlobalSpeedFactor() < 5,
    formatEffect: (value) => `${formatX(value, 2, 2)}`,
  },
  {
    id: 92,
    ...
    effect: () => Math.max((1 - Time.thisInfinity.totalMinutes / debugOptions.getGlobalSpeedFactor()) * 100, 1),
    effectCondition: () => Time.thisInfinity.totalMinutes / debugOptions.getGlobalSpeedFactor() < 1,
    formatEffect: (value) => `${formatX(value, 2, 2)}`,
  },
  {
    id: 93,
    name: '极限超频',
    get description() {
      return `一次大坍缩获得超过 ${format(DC.E300)} 无限点数。`
    },
  ...
  },
  {
    ...
    name: '这安全吗？',
    get description() {
      return `在 ${formatInt(1)} 小时内获得 ${format(Decimal.NUMBER_MAX_VALUE, 1, 0)} 个复制器。`
    },
    get reward() {
      return `无限时保留复制器和${formatInt(1)}个复制器星系。`
    },
  ...
  },
  {
    ...
    name: '如履薄冰',
    get description() {
      return `所有无限挑战的用时之和小于 ${format(6.66, 2, 2)} 秒。`
    },
  ...
  },
  {
    ...
    name: '又一个不存在的成就',
    get description() {
      return `达到 ${formatPostBreak(DC.D9_99999E999, 5, 0)} 无限点数。`
    },
  ...
  },
  {
    ...
    name: '这不是永恒',
    get description() {
      return ` ${formatInt(30)} 秒内永恒。`
    },
    checkRequirement: () => Time.thisEternity.totalSeconds / debugOptions.getGlobalSpeedFactor() <= 30,
    checkEvent: GAME_EVENT.ETERNITY_RESET_BEFORE,
    get reward() {
      return `开始永恒时拥有 ${format(5e25)} 无限点数。`
    },
    effect: 5e25,
  },
  {
    ...
    name: '无限时间',
    get description() {
      return `一次永恒中，从时间维度获得${formatInt(308)}个计数频率升级。`
    },
  ...
  },
  {
    ...
    name: '蜂群',
    get description() {
      return `每 ${formatInt(15)} 秒获得 ${formatInt(10)} 个复制器星系。`
    },
    checkRequirement: () => Replicanti.galaxies.total >= 10 && Time.thisInfinity.totalSeconds / debugOptions.getGlobalSpeedFactor() <= 15,
    checkEvent: GAME_EVENT.REPLICANTI_TICK_AFTER,
  },
  {
    id: 107,
    name: '无需指南',
    get description() {
      return `无限次数小于 ${formatInt(10)} 时，达到永恒。`
    },
  ...
  },
  {
    ...
    name: '9 是买得起的！',
    get description() {
      return `在 ${formatInt(9)} 个复制器时永恒。`
    },
    checkRequirement: () => Replicanti.amount.round().eq(9) || (debugOptions.getUnlockNA108() && Achievement(138).isUnlocked),
    checkEvent: GAME_EVENT.ETERNITY_RESET_BEFORE,
  },
  {
    id: 111,
  ...
  },
  {
    ...
    name: '一去不返',
    get description() {
      return `所有无限挑战的用时之和小于 ${formatInt(750)} 毫秒。`
    },
  ...
  },
  {
    ...
    name: '永恒是新的无限',
    get description() {
      return `在 ${formatInt(250)} 毫秒内达到永恒。`
    },
    checkRequirement: () => Time.thisEternity.totalMilliseconds / debugOptions.getGlobalSpeedFactor() <= 250,
    checkEvent: GAME_EVENT.ETERNITY_RESET_BEFORE,
    get reward() {
      return `多获得 ${formatX(2)} 倍的永恒次数`
    },
    effect: 2,
  },
  {
  ...
  },
  {
    ...
    name: '无需无限',
    get description() {
      return `无限次数小于或等于 ${formatInt(1)} 时，达到永恒。`
    },
    ...
    formatEffect: (value) => {
      ...
      return TimeStudy(31).canBeApplied ? `${formatX(value.pow(1 / TimeStudy(31).effectValue), 2, 1)} （解锁时间研究 31 之后：${mult}）` : mult
    },
  },
  {
    id: 117,
    name: '维度提升现已上架华润万家！',
    get description() {
      return `一次购买 ${formatInt(750)} 个维度提升。`
    },
  ...
  },
  {
    ...
    name: '超过九千',
    get description() {
      return `维度献祭提供的倍数加成达到 ${formatPostBreak(DC.E9000)}。`
    },
  ...
  },
  {
    ...
    name: '无限的无限点数',
    get description() {
      return `达到 ${formatPostBreak('1e30008')} 无限点数。`
    },
  ...
  },
  {
    ...
    name: '5 个永恒后更新',
    get description() {
      return `完成 ${formatInt(50)} 个不同的永恒挑战。`
    },
  ...
  },
  {
    ...
    name: '流行音乐',
    get description() {
      return `复制器星系数量是反物质星系的 ${formatInt(180)} 倍。`
    },
  ...
  },
  {
    ...
    name: '天外有天？',
    get description() {
      return `达到 ${format(Decimal.NUMBER_MAX_VALUE, 1, 0)} 永恒点数。`
    },
  ...
  },
  {
    ...
    name: '我怎么才能摆脱你呢？',
    get description() {
      return `无需任何时间研究达到 ${formatPostBreak('1e22000')} 无限点数。`
    },
  ...
  },
  {
    ...
    name: '不道德的消费',
    get description() {
      return `获得 ${format(DC.D2E9)} 储存的无限次数。`
    },
  ...
  },
  {
    ...
    name: '得寸进尺',
    get description() {
      return `达到 ${formatPostBreak(DC.E18000)} 个复制器。`
    },
  ...
  },
  {
    ...
    name: '比土豆^286078还快。',
    get description() {
      return `计数频率超过 ${formatPostBreak('1e8296262')} 每秒。`
    },
  ...
  },
  {
    ...
    checkRequirement: () => Currency.antimatter.exponent >= 260000 && Time.thisEternity.totalMinutes / debugOptions.getGlobalSpeedFactor() <= 1 && player.dilation.active,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
      return `在时间膨胀中获得的膨胀时间和时间之理 ${formatX(2)}。`
    },
  ...
  },
  {
    ...
    get reward() {
      return `维度提升的效果增强 ${formatPercents(0.5)}。`
    },
    effect: 1.5,
  },
  {
  ...
  },
  {
    ...
    get reward() {
      return `黑洞的冷却时间缩短 ${formatPercents(0.1)}。`
    },
    effect: 0.9,
  },
  {
    ...
    get reward() {
      return `符文稀有度 +${formatPercents(0.01)}。`
    },
    effect: 1,
  },
  {
  ...
  },
  {
    ...
    name: '还有更多的符文吗？',
    get description() {
      return `符文仓库中有 ${formatInt(100)} 个符文。`
    },
  ...
  },
  {
    ...
    name: '多快才叫快',
    get description() {
      return `在游戏内时间 ${formatInt(5)} 秒内达成现实。`
    },
    checkRequirement: () => Time.thisReality.totalSeconds / debugOptions.getGlobalSpeedFactor() <= 5,
    checkEvent: GAME_EVENT.REALITY_RESET_BEFORE,
    get reward() {
      return `现实时有 ${formatPercents(0.1)} 的概率，获得的现实次数和复兴点数 ${formatX(2)}。`
    },
    effect: 0.1,
  },
  {
    ...
    name: '成就 #15983',
    get description() {
      return `游戏内时间达到 ${formatInt(137)} 亿年。`
    },
    checkRequirement: () => Time.totalTimePlayed.totalYears > 13.7e9,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
      return `黑洞的持续时间延长 ${formatPercents(0.1)}。`
    },
    effect: 1.1,
  },
  {
    ...
    checkEvent: GAME_EVENT.REALITY_RESET_BEFORE,
    get reward() {
      return `生产的时间之理 ${formatX(2.5, 0, 1)}, 同时获得一张免费的麦当劳™优惠券。`
    },
    effect: 2.5,
  },
  {
    ...
    name: '效果拔群！',
    get description() {
      return `获得一个 ${formatInt(4)} 词条的符文。`
    },
    checkRequirement: () =>
      Glyphs.activeList
        .concat(Glyphs.inventoryList)
        .map((glyph) => getGlyphEffectsFromBitmask(glyph.effects, 0, 0).filter((effect) => effect.isGenerated).length)
        .max() >= 4,
    checkEvent: GAME_EVENT.GLYPHS_CHANGED,
  },
  {
    ...
    checkEvent: GAME_EVENT.BLACK_HOLE_UPGRADE_BOUGHT,
    get reward() {
      return `黑洞强度增加 ${formatPercents(0.1)}。`
    },
    effect: 1.1,
  },
  {
    ...
    name: '小伙子，你来错地儿了',
    get description() {
      return `时间膨胀时获得 ${formatPostBreak(DC.E1E8)} 反物质。`
    },
  ...
  },
  {
    ...
    checkRequirement: () => EternityChallenges.all.map((ec) => ec.completions).min() >= 5 && Time.thisReality.totalSeconds / debugOptions.getGlobalSpeedFactor() <= 1,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  },
  {
    id: 164,
    name: '无限的无限',
    get description() {
      return `无限次数达到 ${format(Decimal.NUMBER_MAX_VALUE, 1)}。`
    },
    checkRequirement: () => Currency.infinitiesTotal.gte(Decimal.NUMBER_MAX_VALUE),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
      return `获得的无限次数 ${formatInt(1024)}。`
    },
    effect: 1024,
  },
  {
    ...
    name: '完美平衡',
    get description() {
      return `各个符文等级因子的权重相等时，获得一个等级为 ${formatInt(5000)} 的符文。`
    },
    checkRequirement: () =>
      gainedGlyphLevel().actualLevel >= 5000 && ['repl', 'dt', 'eternities'].every((i) => player.celestials.effarig.glyphWeights[i] === player.celestials.effarig.glyphWeights.ep),
    checkEvent: GAME_EVENT.REALITY_RESET_BEFORE,
  ...
  },
  {
    ...
    name: '不错不错。',
    get description() {
      return `获得一个等级恰好为 ${formatInt(6969)} 的符文。`
    },
    checkRequirement: () => gainedGlyphLevel().actualLevel === 6969,
    checkEvent: GAME_EVENT.REALITY_RESET_BEFORE,
    get reward() {
      return `符文等级 +${formatInt(69)}。`
    },
    effect: 69,
  },
  {
    ...
    name: '层级先生？抱歉，您不在名单上。',
    get description() {
      return `达到 ${format(Decimal.NUMBER_MAX_VALUE, 1, 0)} 现实机器。`
    },
  ...
  },
  {
    ...
    name: '行百里者半五十',
    get description() {
      return `太阳神中的总记忆等级达到 ${formatInt(50)}。`
    },
    checkRequirement: () => Ra.totalPetLevel >= 50,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
      return `你可以多获得 ${formatPercents(0.1)} 的记忆。`
    },
    effect: 1.1,
  },
  {
  ...
  },
  {
    ...
    checkRequirement: () =>
      MachineHandler.gainedRealityMachines.gte(Decimal.NUMBER_MAX_VALUE) &&
  ...
  },
  {
    ...
    name: '还是一个不存在的成就',
    get description() {
      return `达到 ${formatPostBreak(DC.D9_99999E999, 5, 0)} 现实机器。`
    },
  ...
  },
  {
    ...
    name: '第一个反历史学家',
    get description() {
      return `所有的炼金资源达到 ${formatInt(Ra.alchemyResourceCap)}。`
    },
  ...
  },
  {
    ...
    name: '灭世者',
    get description() {
      return `获得 ${formatInt(100000)} 反物质星系。`
    },
    checkRequirement: () => player.galaxies >= 100000,
    checkEvent: GAME_EVENT.GALAXY_RESET_AFTER,
    get reward() {
      return `所有星系增强 ${formatPercents(0.01)} 。`
    },
    effect: 1.01,
  },
  {
  ...
  },
  {
    ...
    get reward() {
      return `所有的反物质维度 ${formatPow(1.0812403840463596, 0, 3)}`
    },
