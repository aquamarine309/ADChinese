import { BitUpgradeState } from '../../utils.js'
...
class PelleStrikeState extends BitUpgradeState {
  ...
  onUnlock() {
    GameUI.notify.strike(`你遇到了佩勒冲击: ${this.requirement}`)
...
export const PelleStrikes = mapGameDataToObject(GameDatabase.celestials.pelle.strikes, (config) => new PelleStrikeState(config))
