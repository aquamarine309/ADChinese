...
export const CosmeticGlyphTypes = {
  ...
  ...cosmeticGlyphs,
  get list() {
    return Object.keys({ ...GameDatabase.reality.glyphTypes, ...GameDatabase.reality.cosmeticGlyphs }).map((e) => CosmeticGlyphTypes[e])
  },
}
...
export const GlyphAppearanceHandler = {
  ...
  unlockSet() {
    ...
    GameUI.notify.info(`你解锁了"${entry.name}"符文样式!`, 10000)
