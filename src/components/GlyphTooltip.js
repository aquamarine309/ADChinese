import GlyphTooltipEffect from "./GlyphTooltipEffect.js";
...
export default {
    ...
    description() {
      ...
      switch (this.type) {
        ...
        case "reality":
          return `纯洁的现实符文`;
        default:
          return `${this.rarityInfo.name}的${glyphName}符文`;
      }
    },
    isLevelCapped() {
      return this.displayLevel && this.displayLevel < this.level;
  ...
  >
    ...
    <div
      class="l-glyph-tooltip__effects"
      data-v-glyph-tooltip
    >
      <GlyphTooltipEffect
